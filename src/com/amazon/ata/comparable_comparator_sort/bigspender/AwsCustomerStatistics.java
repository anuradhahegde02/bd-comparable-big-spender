...
public class AwsCustomerStatistics {
    ...
    public List<CustomerServiceSpend> getTopServiceSpendForEachCustomer() {
        ...
        List<CustomerServiceSpend> highestSpendPerCustomer=this.awsServiceInvoiceDao.getHighestServiceSpendsForEachCustomer();
        Collections.sort(highestSpendPerCustomer);
